...
import firebase.util.JacksonUtility;
...
public class FirebaseService {
    ...
    public FirebaseService( String baseUrl ) throws FirebaseException {
    ...
    public FirebaseService(String baseUrl, String secureToken) throws FirebaseException {
        if( baseUrl == null || baseUrl.trim().isEmpty() ) {
            String msg = "baseUrl cannot be null or empty; was: '" + baseUrl + "'";
            LOGGER.error( msg );
            throw new FirebaseException( msg );
    ...
    private String buildFullUrlFromRelativePath( String path ) throws UnsupportedEncodingException {
        ...
        StringBuilder url = new StringBuilder(this.baseUrl + path + FirebaseService.FIREBASE_API_JSON_EXTENSION);
